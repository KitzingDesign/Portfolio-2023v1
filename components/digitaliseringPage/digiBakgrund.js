  ...
  return (
    <div className={styles.container} data-aos="new-animation">
      ...
      <section data-aos="new-animation">
        As everyone knows, spring 2020 didn&apos;t turn out entirely as planned.
        ...
        studies. This resulted in the creation of five new virtual companies.
        We&apos;re living in a time where physical contact is starting to be
        ...
        really take it? <br />
        <br />
        The &quot;companies&quot; below were created by me to experiment with
        the idea of how far virtualization can go before it becomes
        unreasonable. The project is also intended to provoke some thought; how
        much is really lost when you digitalize human interactions?
      </section>
