		...
		<Fragment>
			<div className={styles.containerUpper}>
				...
				<SolutionOne
					...
					secondText="In addition to video surveillance, there is also a Närhet till Ugn(NTU) screen. The screen presents the furnace's condition so that the Smältare can perceive the same indications as currently."
					alt="närhet Till ugn"
				/>
				<SolutionOne
					titel="Communication"
